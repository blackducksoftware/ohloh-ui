    ...
    while (node != null) {
        if (node.nodeType == 1) {
            ...
            var evt = new Timeline.DefaultEventSource.Event(
                ...
                description,
                node.getAttribute("ajaxDescription"),
...
Timeline.DefaultEventSource.Event = function(
        ...
        text, description, ajaxDescription, image, link,
    ...
    this._ajaxDescription = ajaxDescription;
...
Timeline.DefaultEventSource.Event.prototype = {
    ...
    fillInfoBubble: function(elmt, theme, labeller) {
        ...
        var divBody = doc.createElement("div");
				var bodyId = "id" + Math.floor(Math.random() * Math.pow(10, 12));
				divBody.id = bodyId;
