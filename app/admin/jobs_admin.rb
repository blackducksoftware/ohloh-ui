...
ActiveAdmin.register Job do
  ...
  member_action :reschedule, method: :put do
    ...
    if job.running?
      flash[:warning] = I18n.t(:job_cannot_schedule_running)
    else
      ...
      flash[:success] = I18n.t(:job_rescheduled)
    end
  ...
  controller do
    ...
    def update
      ...
      flash[:success] = I18n.t(:job_priority_updated)
      redirect_to admin_job_path(params['id'])
    end

    def destroy
      flash[:success] = I18n.t(:job_deleted)
