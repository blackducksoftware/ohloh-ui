class ProjectWidgetsController < WidgetsController
  ...
  before_action :render_image_for_gif_format, only: [:partner_badge, :thin_badge]
  before_action :render_not_supported_for_gif_format, except: [:partner_badge, :thin_badge, :index]
