module OrgFilters
  ...
  included do
    before_action :set_organization, except: [:index, :new, :create, :resolve_vanity_url, :print_org_infographic, :update]
    ...
    before_action :avoid_global_search, only: [:manage_projects, :claim_projects_list]
  end
