      ...
      def one_day_before_deletion_notice(email)
        { to: "#{email}",
          ...
          body_html:  "Hello, you are receiving this notice because Open Hub has determined that this account is spam
            ...
            <a href=#{ENV['URL_HOST']}/authentications/new /> in order to restore your account. Failure to do so within the 2 week 
      ...
      def account_is_spam_notice(email)
        { to: "#{email}",
          ...
          body_html:  "Hello, you are receiving this notice because Open Hub has determined that this account is spam
            ...
            to verify within the 2 week period, your account and all data associated it will be marked for deletion.
      ...
      def marked_for_spam_notice(email)
        { to: "#{email}",
          ...
          body_html:  "As an effort to eliminate excessive spam accounts, Open Hub has provided you the following link in order
            ...
            to verify your account within the 2 week time span, Open Hub will convert your account status as spam. Thank you.
