...
--
-- Name: account_reports_unknown; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE account_reports_unknown (
    id integer NOT NULL,
...
ALTER SEQUENCE account_reports_id_seq OWNED BY account_reports_unknown.id;
...
--
-- Name: code_set_gestalts_delete; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE code_set_gestalts_delete (
    id integer NOT NULL,
...
ALTER SEQUENCE code_set_gestalts_id_seq OWNED BY code_set_gestalts_delete.id;
...
--
-- Name: countries_delete; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE countries_delete (
    country_code text,
    continent_code text,
    name text,
    region text
...
--
-- Name: old_edits_delete; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE old_edits_delete (
    id integer NOT NULL,
    project_id integer NOT NULL,
    account_id integer NOT NULL,
    created_at timestamp without time zone,
...
ALTER SEQUENCE edits_id_seq OWNED BY old_edits_delete.id;
...
--
-- Name: exhibits_unknown; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE exhibits_unknown (
    id integer NOT NULL,
    report_id integer NOT NULL,
    type text NOT NULL,
    title text,
...
ALTER SEQUENCE exhibits_id_seq OWNED BY exhibits_unknown.id;
...
--
-- Name: follows_delete; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE follows_delete (
    id integer NOT NULL,
...
--
-- Name: message_account_tags_delete; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE message_account_tags_delete (
    id integer NOT NULL,
    message_id integer,
    account_id integer
);
...
--
-- Name: message_project_tags_delete; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE message_project_tags_delete (
    id integer NOT NULL,
    message_id integer,
    project_id integer
);
...
--
-- Name: messages_delete; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
(SELECT f.owner_id, m.id, m.account_id, m.created_at, m.deleted_at, m.body, m.title FROM ((messages_delete m JOIN message_project_tags_delete mpt ON ((mpt.message_id = m.id))) JOIN follows_delete f ON ((f.project_id = mpt.project_id))) WHERE (m.deleted_at IS NULL) UNION SELECT f.owner_id, m.id, m.account_id, m.created_at, m.deleted_at, m.body, m.title FROM (messages_delete m JOIN follows_delete f ON ((f.account_id = m.account_id))) WHERE (m.deleted_at IS NULL)) UNION SELECT mat.account_id AS owner_id, m.id, m.account_id, m.created_at, m.deleted_at, m.body, m.title FROM (messages_delete m JOIN message_account_tags_delete mat ON ((mat.message_id = m.id))) WHERE (m.deleted_at IS NULL);
...
ALTER SEQUENCE follows_id_seq OWNED BY follows_delete.id;
...
--
-- Name: project_gestalts_delete; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE project_gestalts_delete (
    id integer NOT NULL,
    date timestamp without time zone NOT NULL,
    project_id integer,
    gestalt_id integer
...
ALTER SEQUENCE gestaltings_id_seq OWNED BY project_gestalts_delete.id;


--
-- Name: gestalts_delete; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE gestalts_delete (
    id integer NOT NULL,
    type text NOT NULL,
    name text NOT NULL,
    description text
...
ALTER SEQUENCE gestalts_id_seq OWNED BY gestalts_delete.id;
...
--
-- Name: knowledge_base_update_statuses; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE knowledge_base_update_statuses (
    id integer NOT NULL,
...
--
-- Name: knowledge_base_update_statuses_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE knowledge_base_update_statuses_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: knowledge_base_update_statuses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE knowledge_base_update_statuses_id_seq OWNED BY knowledge_base_update_statuses.id;
...
ALTER SEQUENCE message_account_tags_id_seq OWNED BY message_account_tags_delete.id;
...
ALTER SEQUENCE message_project_tags_id_seq OWNED BY message_project_tags_delete.id;
...
ALTER SEQUENCE messages_id_seq OWNED BY messages_delete.id;
...
CREATE TABLE name_language_facts (
    ...
    most_commits integer DEFAULT 0,
...
--
-- Name: organization_activity_facts; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE organization_activity_facts (
    id integer NOT NULL,
    organization_analysis_id integer NOT NULL,
    name_id integer NOT NULL,
    language_id integer NOT NULL,
    month date,
    code_added integer DEFAULT 0,
    code_removed integer DEFAULT 0,
    code_merged integer DEFAULT 0,
    comments_added integer DEFAULT 0,
    comments_removed integer DEFAULT 0,
    comments_merged integer DEFAULT 0,
    blanks_added integer DEFAULT 0,
    blanks_removed integer DEFAULT 0,
    blanks_merged integer DEFAULT 0,
    commits integer DEFAULT 0,
    on_trunk boolean DEFAULT true
);
...
--
-- Name: organization_activity_facts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE organization_activity_facts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: organization_activity_facts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE organization_activity_facts_id_seq OWNED BY organization_activity_facts.id;


--
-- Name: organization_analyses; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE organization_analyses (
    id integer NOT NULL,
    ...
    build_total integer,
    committers_all_time integer,
    committers_twelve_month integer,
    commits_all_time integer,
    commits_twelve_month integer,
    first_commit_time timestamp without time zone,
    last_commit_time timestamp without time zone,
    logged_at timestamp without time zone,
    created_at timestamp without time zone,
...
--
-- Name: organization_analyses_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE organization_analyses_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: organization_analyses_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE organization_analyses_id_seq OWNED BY organization_analyses.id;


--
-- Name: organization_analysis_projects; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE organization_analysis_projects (
    id integer NOT NULL,
    organization_analysis_id integer NOT NULL,
    project_id integer NOT NULL,
    commits_twelve_month integer DEFAULT 0,
    commits_prev_twelve_month integer DEFAULT 0,
    committers_twelve_month integer DEFAULT 0,
    committers_prev_twelve_month integer DEFAULT 0
);


--
-- Name: organization_analysis_projects_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE organization_analysis_projects_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: organization_analysis_projects_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE organization_analysis_projects_id_seq OWNED BY organization_analysis_projects.id;


--
-- Name: organization_analysis_sloc_sets; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE organization_analysis_sloc_sets (
    id integer NOT NULL,
    organization_analysis_id integer NOT NULL,
    sloc_set_id integer NOT NULL,
    analysis_sloc_set_id integer NOT NULL,
    as_of integer,
    logged_at timestamp without time zone
);
...
--
-- Name: organization_analysis_sloc_sets_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE organization_analysis_sloc_sets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: organization_analysis_sloc_sets_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE organization_analysis_sloc_sets_id_seq OWNED BY organization_analysis_sloc_sets.id;


--
-- Name: organization_contributions; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE TABLE organization_contributions (
    ...
    kudo_rank integer,
    commits_twelve_month integer DEFAULT 0,
    commits_all_time integer DEFAULT 0,
...
--
-- Name: organization_contributions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE organization_contributions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: organization_contributions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE organization_contributions_id_seq OWNED BY organization_contributions.id;
...
CREATE TABLE organizations (
    ...
    updated_at timestamp without time zone NOT NULL,
    best_analysis_id integer,
    analyzed_projects_count integer
);
...
--
-- Name: project_events_delete; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE project_events_delete (
    id integer NOT NULL,
    project_id integer,
    type text NOT NULL,
    key text NOT NULL,
...
ALTER SEQUENCE project_events_id_seq OWNED BY project_events_delete.id;
...
--
-- Name: project_reports_delete; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE project_reports_delete (
    id integer NOT NULL,
    project_id integer NOT NULL,
    report_id integer NOT NULL
);
...
ALTER SEQUENCE project_reports_id_seq OWNED BY project_reports_delete.id;
...
--
-- Name: reports_delete; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE reports_delete (
    id integer NOT NULL,
    created_at timestamp without time zone,
    updated_at timestamp without time zone,
    title text
...
ALTER SEQUENCE reports_id_seq OWNED BY reports_delete.id;
...
--
-- Name: sessions_delete; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE sessions_delete (
    id integer NOT NULL,
...
ALTER SEQUENCE sessions_id_seq OWNED BY sessions_delete.id;
...
--
-- Name: tools_unknown; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE tools_unknown (
    id integer NOT NULL,
    name text NOT NULL,
    description text
);
...
ALTER SEQUENCE tools_id_seq OWNED BY tools_unknown.id;
...
ALTER TABLE ONLY account_reports_unknown ALTER COLUMN id SET DEFAULT nextval('account_reports_id_seq'::regclass);
...
ALTER TABLE ONLY code_set_gestalts_delete ALTER COLUMN id SET DEFAULT nextval('code_set_gestalts_id_seq'::regclass);
...
ALTER TABLE ONLY exhibits_unknown ALTER COLUMN id SET DEFAULT nextval('exhibits_id_seq'::regclass);
...
ALTER TABLE ONLY follows_delete ALTER COLUMN id SET DEFAULT nextval('follows_id_seq'::regclass);
...
ALTER TABLE ONLY gestalts_delete ALTER COLUMN id SET DEFAULT nextval('gestalts_id_seq'::regclass);
...
ALTER TABLE ONLY knowledge_base_update_statuses ALTER COLUMN id SET DEFAULT nextval('knowledge_base_update_statuses_id_seq'::regclass);
...
ALTER TABLE ONLY message_account_tags_delete ALTER COLUMN id SET DEFAULT nextval('message_account_tags_id_seq'::regclass);
...
ALTER TABLE ONLY message_project_tags_delete ALTER COLUMN id SET DEFAULT nextval('message_project_tags_id_seq'::regclass);
...
ALTER TABLE ONLY messages_delete ALTER COLUMN id SET DEFAULT nextval('messages_id_seq'::regclass);
...
ALTER TABLE ONLY old_edits_delete ALTER COLUMN id SET DEFAULT nextval('edits_id_seq'::regclass);
...
ALTER TABLE ONLY organization_activity_facts ALTER COLUMN id SET DEFAULT nextval('organization_activity_facts_id_seq'::regclass);
...
ALTER TABLE ONLY organization_analyses ALTER COLUMN id SET DEFAULT nextval('organization_analyses_id_seq'::regclass);
...
ALTER TABLE ONLY organization_analysis_projects ALTER COLUMN id SET DEFAULT nextval('organization_analysis_projects_id_seq'::regclass);
...
ALTER TABLE ONLY organization_analysis_sloc_sets ALTER COLUMN id SET DEFAULT nextval('organization_analysis_sloc_sets_id_seq'::regclass);
...
ALTER TABLE ONLY organization_contributions ALTER COLUMN id SET DEFAULT nextval('organization_contributions_id_seq'::regclass);
...
ALTER TABLE ONLY project_events_delete ALTER COLUMN id SET DEFAULT nextval('project_events_id_seq'::regclass);
...
ALTER TABLE ONLY project_gestalts_delete ALTER COLUMN id SET DEFAULT nextval('gestaltings_id_seq'::regclass);
...
ALTER TABLE ONLY project_reports_delete ALTER COLUMN id SET DEFAULT nextval('project_reports_id_seq'::regclass);
...
ALTER TABLE ONLY reports_delete ALTER COLUMN id SET DEFAULT nextval('reports_id_seq'::regclass);
...
ALTER TABLE ONLY sessions_delete ALTER COLUMN id SET DEFAULT nextval('sessions_id_seq'::regclass);
...
ALTER TABLE ONLY tools_unknown ALTER COLUMN id SET DEFAULT nextval('tools_id_seq'::regclass);
...
ALTER TABLE ONLY account_reports_unknown
...
ALTER TABLE ONLY code_set_gestalts_delete
...
ALTER TABLE ONLY old_edits_delete
...
ALTER TABLE ONLY exhibits_unknown
...
ALTER TABLE ONLY follows_delete
...
ALTER TABLE ONLY gestalts_delete
...
--
-- Name: knowledge_base_update_statuses_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY knowledge_base_update_statuses
    ADD CONSTRAINT knowledge_base_update_statuses_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY message_account_tags_delete
...
ALTER TABLE ONLY message_project_tags_delete
...
ALTER TABLE ONLY messages_delete
...
--
-- Name: organization_activity_facts_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY organization_activity_facts
    ADD CONSTRAINT organization_activity_facts_pkey PRIMARY KEY (id);


--
-- Name: organization_analyses_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY organization_analyses
    ADD CONSTRAINT organization_analyses_pkey PRIMARY KEY (id);


--
-- Name: organization_analysis_projects_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY organization_analysis_projects
    ADD CONSTRAINT organization_analysis_projects_pkey PRIMARY KEY (id);


--
-- Name: organization_analysis_sloc_sets_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY organization_analysis_sloc_sets
    ADD CONSTRAINT organization_analysis_sloc_sets_pkey PRIMARY KEY (id);


--
-- Name: organization_contributions_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY organization_contributions
    ADD CONSTRAINT organization_contributions_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY project_events_delete
...
ALTER TABLE ONLY project_gestalts_delete
...
ALTER TABLE ONLY project_reports_delete
...
ALTER TABLE ONLY reports_delete
...
ALTER TABLE ONLY sessions_delete
...
ALTER TABLE ONLY tools_unknown
...
CREATE INDEX index_account_reports_on_account_id ON account_reports_unknown USING btree (account_id);
...
CREATE INDEX index_account_reports_on_report_id ON account_reports_unknown USING btree (report_id);
...
CREATE INDEX index_code_set_gestalts_on_code_set_id ON code_set_gestalts_delete USING btree (code_set_id);
...
CREATE INDEX index_code_set_gestalts_on_gestalt_id ON code_set_gestalts_delete USING btree (gestalt_id);
...
CREATE INDEX index_exhibits_on_report_id ON exhibits_unknown USING btree (report_id);
...
CREATE INDEX index_follows_on_account_id ON follows_delete USING btree (account_id);
...
CREATE INDEX index_follows_on_owner_id ON follows_delete USING btree (owner_id);
...
CREATE INDEX index_follows_on_project_id ON follows_delete USING btree (project_id);
...
CREATE INDEX index_gestalts_on_name ON gestalts_delete USING btree (name);
...
--
-- Name: index_jobs_organization_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_jobs_organization_id ON jobs USING btree (organization_id);
...
--
-- Name: index_licenses_on_name; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_licenses_on_name ON licenses USING btree (name);
...
CREATE INDEX index_message_account_tags_on_account_id ON message_account_tags_delete USING btree (account_id);
...
CREATE INDEX index_message_account_tags_on_message_id ON message_account_tags_delete USING btree (message_id);
...
CREATE INDEX index_message_project_tags_on_message_id ON message_project_tags_delete USING btree (message_id);
...
CREATE INDEX index_message_project_tags_on_project_id ON message_project_tags_delete USING btree (project_id);
...
CREATE INDEX index_messages_on_account_id ON messages_delete USING btree (account_id);
...
--
-- Name: index_organization_activity_facts_name_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_organization_activity_facts_name_id ON organization_activity_facts USING btree (name_id);


--
-- Name: index_organization_activity_facts_organization_analysis_id_mont; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_organization_activity_facts_organization_analysis_id_mont ON organization_activity_facts USING btree (organization_analysis_id, month);


--
-- Name: index_organization_analyses_logged_at_day; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_organization_analyses_logged_at_day ON organization_analyses USING btree (logged_at, date_trunc('day'::text, logged_at)) WHERE (logged_at IS NOT NULL);


--
-- Name: index_organization_analyses_organization_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_organization_analyses_organization_id ON organization_analyses USING btree (organization_id);


--
-- Name: index_organization_analysis_projects_organization_analysis_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_organization_analysis_projects_organization_analysis_id ON organization_analysis_projects USING btree (organization_analysis_id);


--
-- Name: index_organization_analysis_sloc_sets_on_analysis_sloc_set_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_organization_analysis_sloc_sets_on_analysis_sloc_set_id ON organization_analysis_sloc_sets USING btree (analysis_sloc_set_id);


--
-- Name: index_organization_analysis_sloc_sets_on_sloc_set_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_organization_analysis_sloc_sets_on_sloc_set_id ON organization_analysis_sloc_sets USING btree (sloc_set_id);


--
-- Name: index_organization_analysis_sloc_sets_organization_analysis_id_; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_organization_analysis_sloc_sets_organization_analysis_id_ ON organization_analysis_sloc_sets USING btree (organization_analysis_id, sloc_set_id);


--
-- Name: index_organization_contributions_organization_analysis_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_organization_contributions_organization_analysis_id ON organization_contributions USING btree (organization_analysis_id);


--
-- Name: index_organization_contributions_organization_analysis_id_accou; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_organization_contributions_organization_analysis_id_accou ON organization_contributions USING btree (organization_analysis_id, account_id);


--
-- Name: index_organizations_on_best_analysis_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_organizations_on_best_analysis_id ON organizations USING btree (best_analysis_id);
...
CREATE INDEX index_project_events_on_project_id ON project_events_delete USING btree (project_id);
...
CREATE INDEX index_project_gestalts_on_gestalt_id ON project_gestalts_delete USING btree (gestalt_id);
...
CREATE INDEX index_project_gestalts_on_project_id ON project_gestalts_delete USING btree (project_id);
...
CREATE INDEX index_project_reports_on_project_id ON project_reports_delete USING btree (project_id);
...
CREATE INDEX index_project_reports_on_report_id ON project_reports_delete USING btree (report_id);
...
CREATE INDEX index_sessions_on_session_id ON sessions_delete USING btree (session_id);
...
ALTER TABLE ONLY account_reports_unknown
    ADD CONSTRAINT account_reports_report_id_fkey FOREIGN KEY (report_id) REFERENCES reports_delete(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY code_set_gestalts_delete
    ADD CONSTRAINT code_set_gestalts_gestalt_id_fkey FOREIGN KEY (gestalt_id) REFERENCES gestalts_delete(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY exhibits_unknown
    ADD CONSTRAINT exhibits_report_id_fkey FOREIGN KEY (report_id) REFERENCES reports_delete(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY project_gestalts_delete
    ADD CONSTRAINT gestaltings_gestalt_id_fkey FOREIGN KEY (gestalt_id) REFERENCES gestalts_delete(id) ON DELETE CASCADE;
...
--
-- Name: jobs_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY jobs
    ADD CONSTRAINT jobs_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES organizations(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY message_account_tags_delete
    ADD CONSTRAINT message_account_tags_message_id_fkey FOREIGN KEY (message_id) REFERENCES messages_delete(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY message_project_tags_delete
    ADD CONSTRAINT message_project_tags_message_id_fkey FOREIGN KEY (message_id) REFERENCES messages_delete(id) ON DELETE CASCADE;
...
--
-- Name: organization_activity_facts_language_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY organization_activity_facts
    ADD CONSTRAINT organization_activity_facts_language_id_fkey FOREIGN KEY (language_id) REFERENCES languages(id);


--
-- Name: organization_activity_facts_organization_analysis_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY organization_activity_facts
    ADD CONSTRAINT organization_activity_facts_organization_analysis_id_fkey FOREIGN KEY (organization_analysis_id) REFERENCES organization_analyses(id) ON DELETE CASCADE;


--
-- Name: organization_analyses_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY organization_analyses
    ADD CONSTRAINT organization_analyses_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES organizations(id) ON DELETE CASCADE;


--
-- Name: organization_analysis_projects_organization_analysis_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY organization_analysis_projects
    ADD CONSTRAINT organization_analysis_projects_organization_analysis_id_fkey FOREIGN KEY (organization_analysis_id) REFERENCES organization_analyses(id) ON DELETE CASCADE;


--
-- Name: organization_analysis_projects_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY organization_analysis_projects
    ADD CONSTRAINT organization_analysis_projects_project_id_fkey FOREIGN KEY (project_id) REFERENCES projects(id);


--
-- Name: organization_analysis_sloc_sets_analysis_sloc_set_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY organization_analysis_sloc_sets
    ADD CONSTRAINT organization_analysis_sloc_sets_analysis_sloc_set_id_fkey FOREIGN KEY (analysis_sloc_set_id) REFERENCES analysis_sloc_sets(id);


--
-- Name: organization_analysis_sloc_sets_organization_analysis_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY organization_analysis_sloc_sets
    ADD CONSTRAINT organization_analysis_sloc_sets_organization_analysis_id_fkey FOREIGN KEY (organization_analysis_id) REFERENCES organization_analyses(id) ON DELETE CASCADE;


--
-- Name: organization_analysis_sloc_sets_sloc_set_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY organization_analysis_sloc_sets
    ADD CONSTRAINT organization_analysis_sloc_sets_sloc_set_id_fkey FOREIGN KEY (sloc_set_id) REFERENCES sloc_sets(id);


--
-- Name: organization_contributions_organization_analysis_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY organization_contributions
    ADD CONSTRAINT organization_contributions_organization_analysis_id_fkey FOREIGN KEY (organization_analysis_id) REFERENCES organization_analyses(id) ON DELETE CASCADE;


--
-- Name: organizations_best_analysis_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY organizations
    ADD CONSTRAINT organizations_best_analysis_id_fkey FOREIGN KEY (best_analysis_id) REFERENCES organization_analyses(id);
...
ALTER TABLE ONLY project_reports_delete
    ADD CONSTRAINT project_reports_report_id_fkey FOREIGN KEY (report_id) REFERENCES reports_delete(id) ON DELETE CASCADE;
...
INSERT INTO schema_migrations (version) VALUES ('20121030065123');
...
INSERT INTO schema_migrations (version) VALUES ('20130125032851');
