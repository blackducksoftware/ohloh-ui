...
--
-- Name: semaphores; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: semaphores_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: semaphores_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: semaphores_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: index_semaphores_on_execution_type; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_semaphores_on_execution_type ON semaphores USING btree (execution_type);
...
--
-- Name: fk_rails_aea5b458a1; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY api_keys
    ADD CONSTRAINT fk_rails_aea5b458a1 FOREIGN KEY (oauth_application_id) REFERENCES oauth_applications(id);
...
INSERT INTO schema_migrations (version) VALUES ('20141202095733');

INSERT INTO schema_migrations (version) VALUES ('20150321131514');
...
INSERT INTO schema_migrations (version) VALUES ('20150817104547');
