...
--
-- Name: index_on_commits_name_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_on_commits_name_id ON commits USING btree (name_id);


--
-- Name: index_on_commits_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_on_commits_time ON commits USING btree ("time");
