...
class FOSSerBadgeTest < ActiveSupport::TestCase
  ...
  describe 'name' do
    it 'should return name' do
      fosser_badge.name.must_equal 'FLOSSer'
    end
  end

  describe 'to_underscore' do
    it 'should return fosser' do
      fosser_badge.to_underscore.must_equal 'fosser'
    end
  end

  describe 'level_limits' do
    it 'should return limits' do
      fosser_badge.level_limits.must_equal [1, 3, 6, 10, 20, 50, 100, 200]
    end
  end

  describe 'position' do
    it 'should return 60' do
      fosser_badge.position.must_equal 60
    end
  end
end
