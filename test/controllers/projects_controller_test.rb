...
class ProjectsControllerTest < ActionController::TestCase
  ...
  describe 'similar' do
    it 'should return similar projects (both by tags and stacks)' do
      ...
      assigns(:similar_by_tags).must_equal [project2, project3]
      assigns(:similar_by_stacks).must_equal [project2, project3]
    end
  end
end
